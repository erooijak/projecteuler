...
(define prime-count 1500) ; 1500 for up to 10.000 75000 necessary for up to 1.000.000

(define (prime-sieve n)
  ; TODO, sieve that returns a vector (for the fast lookup)
  )
...
(define primes-list (sieve-to-list (prime-sieve prime-count) prime-count))
...
(define (prime? x)
  (vector-ref (prime-sieve prime-count) x))
